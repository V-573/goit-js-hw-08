...
player.on('timeupdate', function (data) {//ecucho el evento 'timeupdate' del reproductor de vimeo. este evento se dispara periodicamente mientras el video se esta reproducioendo
